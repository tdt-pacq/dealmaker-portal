...
const YearSec = ({yd,onChange,onImport}) => {
  ...
  return (
    <div className="card mb-4">
      <div className="flex items-center justify-between px-4 py-4 cursor-pointer select-none hover:bg-gray-900 rounded-lg"
...
IMPORTANT: For income.otherIncome, capture any "Other income" items shown between Gross profit and Total income on the return. Exact lines: 1120-S Lines 4–5 (net gain from Form 4797, other income) · 1065 Lines 4–7 · 1120 Lines 8–10 · Schedule C Line 6. Sum all such other income items into a single number. Use null if none present. Do NOT include the ordinary business income/loss line.
